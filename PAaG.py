...
def Grafico_ME(op):
    if op == "Po":
        ...
        try:
            ...
            #Escrever a chamada a função que cria o arquivo em png do gráfico
...
print('Criação do arquivo minim.mdp')
...
try:
    ...
    with open('processo.txt','a') as arquivo:
        arquivo.write(f'\n 13) Equilibração do sistema através de um processo NVT')
except Exception as E:
    print('Encontramos um erro equilibrar o sistema através do processo NVT')
    ERRO(E)
    with open('processo.txt', 'a') as arquivo:
        arquivo.write(f'\n 13) Erro na equilibração através do processo NVT')
